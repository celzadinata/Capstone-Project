    ...
    <div class="container role">
        <div class="card mt-4 mb-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="row g-0">
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <h2 class="card-title px-4 pt-4">Mendaftar sebagai :</h2>
                        <form method="GET" action="{{ route('register') }}">
                            @csrf
                            <div class="p-3">
                                <label class="rad-label" for="reseller">
                                    <input id="reseller" type="radio" class="rad-input" name="role" value="reseller"
                                        required>
                                    <div class="rad-design"></div>
                                    <div class="rad-text">Calon Reseller</div>
                                </label>
                                <label class="rad-label" for="pengusaha">
                                    <input id="pengusaha" type="radio" class="rad-input" name="role" value="pengusaha"
                                        required>
                                    <div class="rad-design"></div>
                                    <div class="rad-text">Pengusaha</div>
                                </label>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn-role">Berikutnya</button>
