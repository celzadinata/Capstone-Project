    ...
    public function run()
    {
        $produk = [
            ...
            [
                ...
                'status' => 'Konfirmasi',
                'tampilkan' => '1',
                'slug' => Str::slug('daia putih 1 kardus 72sachet')
            ],
            [
                'id' => 'LDY03',
                'users_id' => 'ABC06060',
            ...
            [
                ...
                'status' => 'Konfirmasi',
                'tampilkan' => '1',
                'slug' => Str::slug('soklin softergen 1 kardus')
            ],
            ...
            [
                ...
                'status' => 'Konfirmasi',
                'tampilkan' => '1',
                'slug' => Str::slug('roti tawar kasino')
            ],
            ...
            [
                ...
                'status' => 'Konfirmasi',
                'tampilkan' => '1',
                'slug' => Str::slug('selai strawberry')
            ],
            ...
            [
                ...
                'status' => 'Konfirmasi',
                'tampilkan' => '1',
                'slug' => Str::slug('mie goreng 1 dus ayam bawang')
            ],
            [
                'id' => 'WM003',
                'users_id' => 'NFLT0066',
                ...
                'status' => 'Konfirmasi',
                'tampilkan' => '1',
                'slug' => Str::slug('mie goreng 1 dus aceh')
            ],
            [
                'id' => 'WM004',
                'users_id' => 'NFLT0066',
                ...
                'status' => 'Konfirmasi',
                'tampilkan' => '1',
                'slug' => Str::slug('mie goreng 1 dus')
            ],
