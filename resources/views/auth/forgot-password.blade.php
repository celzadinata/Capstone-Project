    ...
    <div class="container login py-5">
        <div class="card mt-4 mb-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="row g-0">
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <h2 class="card-title my-2">Lupa Password</h2>
                        <!-- Session Status -->
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div>
                                ...
                                <x-text-input class="form-control" id="email" class="block mt-1 w-full" type="email"
                                    name="email" :value="old('email')" required autofocus />
                            </div>

                            <div class="flex items-center justify-end mt-4">
                                <x-primary-button class="btn-resell">
                                    {{ __('Email Password Reset Link') }}
                                </x-primary-button>
                            </div>
                        </form>
                        <div class="mt-1 mb-5">
                            <p>Sudah Punya Akun? <a href="{{ route('login') }}" class="btn-daftar">Login</a></p>
                        </div>
                    </div>
                </div>
            </div>
